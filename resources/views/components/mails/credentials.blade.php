                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-bottom:20px;font-size:0px"><img
                                    src="https://efhnvqx.stripocdn.email/content/guids/CABINET_093800117dbc11a4d262d0b2283c0f92b25c1300679b9c923cab3935d3bedc28/images/logo.png"
                                    alt="Logo"
                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size:12px"
                                    width="130" title="Logo"></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                              ...
                              <tr>
                                <td align="center"
                                  style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0px"><img
                                    src="https://efhnvqx.stripocdn.email/content/guids/CABINET_093800117dbc11a4d262d0b2283c0f92b25c1300679b9c923cab3935d3bedc28/images/dsuccess.png"
                                    alt
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                  <p
                                    ...
                                    Hello,<strong> {{ $user->first_name }}!</strong><br><br>Thank you for joining us!
                                    We're thrilled to have you on board. Below are the details for your Dormy account:
                                  </p>
                                </td>
                              </tr>
                            </table>
                  ...
                  <tr class="es-mobile-hidden">
                    <td class="es-m-p25t es-m-p25b es-m-p40r es-m-p25l" align="left"
                      ...
                      <table cellpadding="0" cellspacing="0" class="es-left" align="left" role="none"
                        ...
                        <tr class="es-mobile-hidden">
                          <td class="es-m-p20b" align="left" style="padding:0;Margin:0;width:80px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr class="es-mobile-hidden">
                                <td align="left" style="padding:0;Margin:0">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    {{ $user->first_name }} {{ $user->first_name }}</p>
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    {{ $user->position }}</p>
                                  <p
                        ...
                        <tr>
                          <td align="left" style="padding:0;Margin:0;width:600px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr>
                                <td align="left" class="es-m-p5" style="padding:0;Margin:0">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    <strong>Role:</strong> {{ $user->position }}</p>
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-bottom:30px;padding-top:40px">
                                  <p
                                    ...
                                    team.<br>Email us at dormy.dev@gmail.com. We're here to help!</p>
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    <br>Sincerely,</p>
                                  <p
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-bottom:35px">
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;color:#333333;font-size:12px">
                                    8700 Syre Highway, Malaybalay City, Bukidnon, Philippines</p>
                                </td>
                              </tr>
                            </table>
                          </td>
